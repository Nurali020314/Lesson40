    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        object : CountDownTimer(60000, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                if (secound==45){
                    binding.apply {
                        code1Tv.text= Character.getNumericValue(settingsImpl.code.toString()[0]).toString()
                        code2Tv.text= Character.getNumericValue(settingsImpl.code.toString()[1]).toString()
                        code3Tv.text= Character.getNumericValue(settingsImpl.code.toString()[2]).toString()
                        code4Tv.text= Character.getNumericValue(settingsImpl.code.toString()[3]).toString()
                        code5Tv.text= Character.getNumericValue(settingsImpl.code.toString()[4]).toString()
                        code6Tv.text= Character.getNumericValue(settingsImpl.code.toString()[5]).toString()
                    }
                }
